        ...
        <div class="ge-messages">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <? $this->load->view('element/messages', array('messages' => $messages, 'request' => $request, 'to' => $requestor_user, 'canMessage' => true, 'showProfileLinks' => true, 'currentUser' => $currentUser)); ?>
                </div>
            </div>
        </div><!--./ge-messages-->

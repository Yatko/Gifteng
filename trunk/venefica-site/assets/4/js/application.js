...
(function($) {
  ...
  $(function() {
    ...
    // Custom Selects
    $("select.select-huge").selectpicker({style: 'btn-huge btn-primary', menuStyle: 'dropdown-inverse'});
    $("select.select-large").selectpicker({style: 'btn-large btn-danger'});
    $("select.select-info").selectpicker({style: 'btn-info'});
    $("select.select-small").selectpicker({style: 'btn-small btn-warning'});
    ...
    $('.ge-datepicker').datepicker({
      ...
      e && e.preventDefault();
      var dp = $(this).next('.ge-datepicker');
      if ( dp.prop('disabled') ) {
          return;
      }
      dp.focus();

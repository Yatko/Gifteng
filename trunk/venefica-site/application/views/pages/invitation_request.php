...
<div class="container">
    ...
    <? if ( $step == 3 ): ?>
			...
			<!-- #login9 -->
			<div id="login9" class="span6"><!-- ge-topspace outside of span -->
    ...
    <? elseif ( $step == 2 ): ?>
        ...
        <!-- #login5 -->
			<div id="login5" class="span6"><!-- ge-topspace outside of span -->
				<div class="ge-topspace">
					<div class="well ge-well ge-authbox">
						<div class="ge-well-content ge-form">
							<div class="row-fluid">
    ...
    <? else: ?>
        ...
        <!-- #login1 -->
			<div id="login1" class="span6"><!-- ge-topspace outside of span -->
				<div class="ge-topspace">
					<div class="well ge-well ge-authbox">
						<div class="ge-well-content ge-form">
							<div class="row-fluid">

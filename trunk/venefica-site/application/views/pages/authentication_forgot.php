...
<div class="container">
    <div class="row">
        ...
        <? else: ?>
            ...
            <!-- #login3 -->
			<div id="login3" class="span6"><!-- ge-topspace outside of span -->
				<div class="ge-topspace">
					<div class="well ge-well ge-authbox">
						<div class="ge-well-content ge-form">
							<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="span8 offset2">
									<div class="control-group large">
										<div class="controls">
											<input name="forgot_password_email" type="email" value="<?=set_value('forgot_password_email')?>" placeholder="<?=lang('forgot_password_email_hint')?>" class="span3">
										</div>
									</div>
								</div>
							</div><!--./email-->

...
public class BookmarkListAdapter extends ArrayAdapter<Product>
{
	...
	public BookmarkListAdapter(Context context, int textViewResourceId, List<Product> BookmarkAds)
	{
		super(context, textViewResourceId, BookmarkAds);
		this.Products = BookmarkAds;
	}

...
-- Ads
delete from ad;
insert into ad (id, adData_id, creator_id, createdAt, expired, deleted, sold, numviews, reviewed, spam, numavailprolongations, rating, numexpire, status, expires, approved, online, hiddenForSearch, staffPick) values (nextval('ad_id_seq'), 1, 1, now(), 'f', 'f', 'f', 0, 'f', 'f', 1, 0.0, 0, 'ACTIVE', 't', 't', 't', 'f', 'f');

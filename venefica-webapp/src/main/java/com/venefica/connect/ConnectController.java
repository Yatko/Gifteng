...
/**
 * Allows to connect the local user account with accounts of well-known social networks. This
 * controller is based on {@link org.springframework.social.connect.web.ConnectController}.
 * 
...
public class ConnectController {
	 ...
	 * 
	 * @param connectErrorUrl
	 *            the connect error URL
	 */
	...
	/**
	 * Process a connect request by commencing the process of establishing a connection to the

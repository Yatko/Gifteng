define(['controllers'], function(controllers) {
	...
	controllers.controller('BookmarkedAdsController', ["$scope", "$routeParams", "User", "UserEx", "AdDialog", "AdBookmarked", "GeModel", "Filters", "$window", function($scope, $routeParams, User, UserEx, AdDialog, AdBookmarked, GeModel, Filters, $window) {
		$scope.loaded=false;
		...
		$scope.loadAds = function() {
			...
			if(typeof($routeParams.id)!=='undefined') {
				...
				ads = AdBookmarked.query({id:$routeParams.id}, function() {
					$scope.ads = ads.ads;
				...
				$scope.$watch(
					...
					function(user) {
						if(typeof(user.data) !== 'undefined') {
							ads = AdBookmarked.query({id:user.data.id}, function() {
								$scope.ads = ads.ads;
								$scope.creators = ads.creators;
								GeModel.creators = ads.creators;
								$scope.loaded=true;
